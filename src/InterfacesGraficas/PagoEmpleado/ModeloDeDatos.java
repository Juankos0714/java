...
public class ModeloDeDatos {
    ...
    public String registrarEstudiante(Estudiante est) {
        ...
        if (empleadosMap.containsKey(documento)) {
            return "Estudiante existente";
        }

        // Storing a deep copy to prevent external modification
        empleadosMap.put(documento, copyEstudiante(est));
        return "ok";
    }
    ...
    public Estudiante consultaEstudiante(String documento) {
        ...
        Estudiante estudiante = empleadosMap.get(documento.trim());
    ...
    public boolean eliminarEstudiante(String documento) {
        ...
        return empleadosMap.remove(documento.trim()) != null;
    }
     ...
     */
    public Map<String, Estudiante> getEmpleadosMap() {
        return Collections.unmodifiableMap(empleadosMap);
    }
